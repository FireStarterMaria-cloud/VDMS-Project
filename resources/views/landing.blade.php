...
<head>
  ...
  <style>
    :root {
      --p: #696cff; --pd: #5f61e6; --pl: rgba(105,108,255,0.15);
      --bg: #0d0d1a; --dark: #f0f0ff; --text: #9a9abf;
      --success: #71dd37; --warning: #ffab00; --info: #03c3ec;
    }
    *{margin:0;padding:0;box-sizing:border-box}
    html{scroll-behavior:smooth}
    body{font-family:'Public Sans',sans-serif;background:#07070f;overflow-x:hidden;color:#f0f0ff;}

    .cursor-glow{position:fixed;width:280px;height:280px;border-radius:50%;background:radial-gradient(circle,rgba(105,108,255,0.08) 0%,transparent 70%);pointer-events:none;z-index:0;transform:translate(-50%,-50%);transition:left .1s,top .1s}

    /* NAV */
    .nav{position:fixed;top:0;left:0;right:0;z-index:999;background:rgba(7,7,15,0.85);backdrop-filter:blur(20px);border-bottom:1px solid rgba(105,108,255,0.15);transition:all .3s}
    ...
    .nav-brand-text{font-size:20px;font-weight:700;color:#f0f0ff}
    .nav-brand-text span{color:var(--p)}
    .nav-links{display:flex;align-items:center;gap:28px}
    .nav-links a{color:#7a7a9a;text-decoration:none;font-size:14px;font-weight:500;transition:color .2s;position:relative;cursor:pointer}
    ...
    .nav-toggle{display:none;background:none;border:none;font-size:26px;color:#f0f0ff;cursor:pointer}

    /* MOBILE MENU */
    .mobile-overlay{position:fixed;inset:0;background:rgba(0,0,0,.7);z-index:1000;opacity:0;pointer-events:none;transition:opacity .3s}
    .mobile-overlay.open{opacity:1;pointer-events:all}
    .mobile-menu{position:fixed;top:0;right:-300px;width:280px;height:100vh;background:#0d0d1a;z-index:1001;transition:right .3s;padding:0;box-shadow:-10px 0 40px rgba(0,0,0,.5);border-left:1px solid rgba(105,108,255,0.15)}
    .mobile-menu.open{right:0}
    .mobile-menu-header{padding:20px 24px;display:flex;justify-content:space-between;align-items:center;border-bottom:1px solid rgba(105,108,255,0.15)}
    .mobile-menu-header span{font-weight:700;color:#f0f0ff;font-size:16px}
    .mobile-menu-header button{background:none;border:none;font-size:22px;cursor:pointer;color:#7a7a9a}
    .mobile-menu a{display:block;padding:16px 24px;color:#f0f0ff;text-decoration:none;font-weight:500;border-bottom:1px solid rgba(105,108,255,0.08);transition:all .2s}
    .mobile-menu a:hover{color:var(--p);padding-left:32px;background:rgba(105,108,255,0.08)}
    .mobile-menu .btn-login{margin:20px 24px;display:flex;justify-content:center}

    /* HERO */
    .hero{min-height:100vh;background:linear-gradient(135deg,#07070f 0%,#0d0d1a 40%,#07070f 100%);display:flex;align-items:center;padding-top:80px;position:relative;overflow:hidden}
    ...
    .hero-title{font-size:50px;font-weight:800;color:#f0f0ff;line-height:1.15;margin-bottom:20px;letter-spacing:-1px;opacity:0;animation:fiu .7s ease .2s forwards}
    ...
    .hero-desc{font-size:16px;color:#7a7a9a;line-height:1.8;margin-bottom:36px;opacity:0;animation:fiu .8s ease .3s forwards}
    ...
    .btn-hero-s{background:rgba(255,255,255,.06);color:rgba(255,255,255,.75);padding:14px 32px;border-radius:10px;text-decoration:none;font-weight:500;font-size:15px;display:inline-flex;align-items:center;gap:8px;border:1px solid rgba(255,255,255,.12);transition:all .3s;cursor:pointer}
    .btn-hero-s:hover{background:rgba(255,255,255,.1);color:#fff;transform:translateY(-2px)}
    ...
    .stat-n p{font-size:12px;color:rgba(255,255,255,.35);margin-top:4px;text-transform:uppercase;letter-spacing:.5px}
    .hero-mockup{opacity:0;animation:fir .8s ease .3s forwards}
    .mockup-win{background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.1);border-radius:20px;overflow:hidden;box-shadow:0 30px 80px rgba(0,0,0,.6);cursor:pointer;transition:transform .4s}
    ...
    .chip{display:inline-block;background:rgba(105,108,255,0.15);color:var(--p);border:1px solid rgba(105,108,255,0.2);padding:5px 16px;border-radius:50px;font-size:12px;font-weight:600;letter-spacing:.5px;text-transform:uppercase;margin-bottom:14px}
    .sh{font-size:36px;font-weight:700;color:#f0f0ff;margin-bottom:12px;letter-spacing:-.5px}
    .ss{font-size:15px;color:#7a7a9a;line-height:1.8;max-width:540px;margin-bottom:56px}

    /* FEATURES */
    .features{padding:100px 0;background:#0d0d1a}
    .feat-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:24px}
    .fc{background:#121220;border-radius:16px;padding:28px;border:1px solid rgba(105,108,255,.12);transition:all .3s;cursor:pointer;position:relative;overflow:hidden;text-decoration:none;display:block}
    ...
    .fc:hover{transform:translateY(-6px);box-shadow:0 12px 40px rgba(105,108,255,.15);border-color:rgba(105,108,255,.3)}
    .fc:hover::before{transform:scaleX(1)}
    .fi{width:52px;height:52px;background:rgba(105,108,255,0.12);border-radius:14px;display:flex;align-items:center;justify-content:center;margin-bottom:18px;transition:all .3s;border:1px solid rgba(105,108,255,0.15)}
    .fc:hover .fi{background:var(--p);border-color:var(--p)}
    .fi i{font-size:24px;color:var(--p);transition:color .3s}
    .fc:hover .fi i{color:#fff}
    .fc h4{font-size:16px;font-weight:600;color:#f0f0ff;margin-bottom:8px}
    .fc p{font-size:13px;color:#7a7a9a;line-height:1.7}

    /* MODULES */
    .modules{padding:100px 0;background:#07070f}
    .mod-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:20px;margin-top:48px}
    .mod-card{background:#0d0d1a;border-radius:14px;padding:24px 20px;border:1px solid rgba(105,108,255,.12);transition:all .3s;cursor:pointer;text-align:center;text-decoration:none;display:block}
    .mod-card:hover{background:rgba(105,108,255,0.12);border-color:var(--p);transform:translateY(-5px);box-shadow:0 10px 30px rgba(105,108,255,.15)}
    .mod-icon{width:56px;height:56px;border-radius:14px;display:flex;align-items:center;justify-content:center;margin:0 auto 14px;font-size:26px;color:var(--p);background:rgba(105,108,255,0.12);border:1px solid rgba(105,108,255,0.15);transition:all .3s}
    .mod-card:hover .mod-icon{background:var(--p);color:#fff;border-color:var(--p)}
    .mod-card h5{font-size:14px;font-weight:600;color:#f0f0ff;margin-bottom:6px}
    .mod-card p{font-size:12px;color:#7a7a9a;line-height:1.6}

    /* BRANCHES */
    .branches-s{padding:80px 0;background:#0d0d1a}
    .branch-flex{display:flex;justify-content:center;gap:16px;flex-wrap:wrap;margin-top:48px}
    .bcard{display:flex;align-items:center;gap:12px;background:#121220;border:1px solid rgba(105,108,255,.15);border-radius:14px;padding:16px 24px;transition:all .3s;cursor:pointer}
    .bcard:hover{background:rgba(105,108,255,0.12);border-color:var(--p);transform:translateY(-4px);box-shadow:0 8px 25px rgba(105,108,255,.15)}
    ...
    .bcard h5{font-size:15px;font-weight:600;color:#f0f0ff;margin:0}
    .bcard p{font-size:12px;color:#7a7a9a;margin:0}

    /* STATS */
    .stats-s{padding:80px 0;background:linear-gradient(135deg,#0d0d1a,#121230)}
    ...
    .si p{font-size:14px;color:rgba(255,255,255,.4);margin-top:8px;text-transform:uppercase;letter-spacing:.5px}
    ...
    /* ROLES */
    .roles-s{padding:100px 0;background:#07070f}
    .roles-g{display:grid;grid-template-columns:repeat(5,1fr);gap:20px;margin-top:48px}
    .rc{background:#121220;border-radius:16px;padding:28px 16px;text-align:center;border:1px solid rgba(105,108,255,.12);transition:all .3s;cursor:pointer}
    .rc:hover{transform:translateY(-6px);box-shadow:0 12px 35px rgba(105,108,255,.15);border-color:var(--p)}
    ...
    .r1{background:rgba(105,108,255,.12);color:var(--p)}
    .r2{background:rgba(145,85,253,.12);color:#9155fd}
    ...
    .rc h5{font-size:13px;font-weight:600;color:#f0f0ff;margin-bottom:6px}
    .rc p{font-size:12px;color:#7a7a9a;line-height:1.6}

    /* PWA SECTION */
    .pwa-s{padding:80px 0;background:#0d0d1a}
    ...
    .pwa-list li{display:flex;align-items:center;gap:12px;padding:10px 0;font-size:14px;color:#7a7a9a;border-bottom:1px solid rgba(105,108,255,0.1)}
    .pwa-list li:last-child{border-bottom:none}
    .pwa-list i{font-size:20px;color:var(--p)}
    .pwa-visual{background:linear-gradient(135deg,#0d0d1a,#121230);border:1px solid rgba(105,108,255,0.15);border-radius:20px;padding:32px;text-align:center}
    .pwa-icon-big{font-size:80px;color:var(--p);display:block;margin-bottom:16px}
    .pwa-visual h4{color:#f0f0ff;font-size:20px;font-weight:700;margin-bottom:8px}
    .pwa-visual p{color:#7a7a9a;font-size:14px;line-height:1.7}
    .pwa-tags{display:flex;gap:8px;justify-content:center;flex-wrap:wrap;margin-top:16px}
    .pwa-tag{background:rgba(105,108,255,.12);color:#a8aaff;padding:4px 12px;border-radius:20px;font-size:12px;font-weight:500;border:1px solid rgba(105,108,255,0.15)}

    /* CTA */
    .cta-s{padding:100px 0;background:linear-gradient(135deg,#0d0d1a,#121230);text-align:center;position:relative;overflow:hidden}
    .cta-s::before{content:'';position:absolute;top:-50%;left:50%;transform:translateX(-50%);width:600px;height:600px;background:radial-gradient(circle,rgba(105,108,255,.08) 0%,transparent 70%);border-radius:50%}
    ...
    .cta-inner p{font-size:17px;color:#7a7a9a;margin-bottom:36px;line-height:1.7}
    .cta-btns{display:flex;gap:14px;justify-content:center;flex-wrap:wrap}

    /* FOOTER */
    .footer{background:#03030a;padding:40px 0;border-top:1px solid rgba(105,108,255,0.1)}
    ...
    .footer p{color:rgba(255,255,255,.3);font-size:14px}
    .footer span{color:var(--p)}
    .footer-links{display:flex;gap:20px}
    .footer-links a{color:rgba(255,255,255,.3);font-size:13px;text-decoration:none;transition:color .2s}
    ...
    /* VEHICLE CARDS dark */
    .vcard-dark{background:#121220;border-radius:16px;overflow:hidden;border:1px solid rgba(105,108,255,.15);transition:all .3s;text-decoration:none;display:block}
    .vcard-dark:hover{transform:translateY(-6px);box-shadow:0 12px 40px rgba(105,108,255,.15);border-color:rgba(105,108,255,.35)}
...
<section class="vh-slide" id="home">
  ...
  <div class="overlay" style="background:linear-gradient(135deg,rgba(7,7,15,0.92) 0%,rgba(105,108,255,0.15) 100%)"></div>
  <div class="vcontent" style="width:100%">
    <div style="max-width:650px">
      ...
      <div style="display:flex;gap:40px;margin-top:48px;padding-top:32px;border-top:1px solid rgba(255,255,255,.12);opacity:0;animation:fiu 1s ease .5s forwards">
        <div class="stat-n" onclick="smoothTo('branches')"><div style="font-size:32px;font-weight:800;color:#fff">5<span style="color:#696cff">+</span></div><div style="font-size:12px;color:rgba(255,255,255,.4);text-transform:uppercase;letter-spacing:.5px;margin-top:4px">Branches</div></div>
        <div class="stat-n" onclick="smoothTo('modules')"><div style="font-size:32px;font-weight:800;color:#fff">12<span style="color:#696cff">+</span></div><div style="font-size:12px;color:rgba(255,255,255,.4);text-transform:uppercase;letter-spacing:.5px;margin-top:4px">Modules</div></div>
        <div class="stat-n" onclick="smoothTo('roles')"><div style="font-size:32px;font-weight:800;color:#fff">5</div><div style="font-size:12px;color:rgba(255,255,255,.4);text-transform:uppercase;letter-spacing:.5px;margin-top:4px">User roles</div></div>
        <div class="stat-n" onclick="smoothTo('features')"><div style="font-size:32px;font-weight:800;color:#fff">100<span style="color:#696cff">%</span></div><div style="font-size:12px;color:rgba(255,255,255,.4);text-transform:uppercase;letter-spacing:.5px;margin-top:4px">Role-based</div></div>
      </div>
    </div>
  </div>
</section>
...
<section class="vh-slide" id="features" style="min-height:80vh">
  ...
  <div class="overlay" style="background:linear-gradient(to right,rgba(7,7,15,0.97) 50%,rgba(7,7,15,0.4) 100%)"></div>
  <div class="vcontent" style="width:100%">
    <div style="max-width:560px">
      <span class="chip reveal">Why Velora?</span>
      <h2 class="sh reveal">Everything your dealership needs</h2>
      <p style="color:rgba(255,255,255,.55);font-size:15px;line-height:1.8;margin-bottom:40px" class="reveal">From vehicle inventory to sales, payments, branch transfers and analytics — all in one place.</p>
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
        <a href="{{ route('login') }}" style="background:rgba(255,255,255,.05);border:1px solid rgba(105,108,255,.2);border-radius:14px;padding:18px;text-decoration:none;transition:all .3s;display:block" class="reveal" onmouseover="this.style.background='rgba(105,108,255,.12)';this.style.borderColor='rgba(105,108,255,.5)'" onmouseout="this.style.background='rgba(255,255,255,.05)';this.style.borderColor='rgba(105,108,255,.2)'">
          ...
          <div style="color:rgba(255,255,255,.4);font-size:12px">Track all vehicles with QR codes</div>
        </a>
        <a href="{{ route('login') }}" style="background:rgba(255,255,255,.05);border:1px solid rgba(105,108,255,.2);border-radius:14px;padding:18px;text-decoration:none;transition:all .3s;display:block" class="reveal" onmouseover="this.style.background='rgba(105,108,255,.12)';this.style.borderColor='rgba(105,108,255,.5)'" onmouseout="this.style.background='rgba(255,255,255,.05)';this.style.borderColor='rgba(105,108,255,.2)'">
          ...
          <div style="color:rgba(255,255,255,.4);font-size:12px">Track every sale in real-time</div>
        </a>
        <a href="{{ route('login') }}" style="background:rgba(255,255,255,.05);border:1px solid rgba(105,108,255,.2);border-radius:14px;padding:18px;text-decoration:none;transition:all .3s;display:block" class="reveal" onmouseover="this.style.background='rgba(105,108,255,.12)';this.style.borderColor='rgba(105,108,255,.5)'" onmouseout="this.style.background='rgba(255,255,255,.05)';this.style.borderColor='rgba(105,108,255,.2)'">
          ...
          <div style="color:rgba(255,255,255,.4);font-size:12px">Email, WhatsApp & print</div>
        </a>
        <a href="{{ route('login') }}" style="background:rgba(255,255,255,.05);border:1px solid rgba(105,108,255,.2);border-radius:14px;padding:18px;text-decoration:none;transition:all .3s;display:block" class="reveal" onmouseover="this.style.background='rgba(105,108,255,.12)';this.style.borderColor='rgba(105,108,255,.5)'" onmouseout="this.style.background='rgba(255,255,255,.05)';this.style.borderColor='rgba(105,108,255,.2)'">
          ...
          <div style="color:rgba(255,255,255,.4);font-size:12px">5 roles, branch isolation</div>
        </a>
      </div>
...
<section class="vh-slide" id="vehicles-showcase" style="min-height:80vh">
  ...
  <div class="overlay" style="background:linear-gradient(to bottom,rgba(7,7,15,0.85) 0%,rgba(7,7,15,0.95) 100%)"></div>
  <div class="vcontent" style="width:100%;text-align:center">
    <span class="chip reveal" style="background:rgba(105,108,255,.15);color:#a8aaff">Our inventory</span>
    ...
    <p style="color:rgba(255,255,255,.5);font-size:15px;margin-bottom:48px;max-width:540px;margin-left:auto;margin-right:auto" class="reveal">Browse available Toyota vehicles across all 5 branches — click any card to view full details.</p>
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:24px" class="reveal">
      <a href="{{ route('login') }}" style="background:rgba(255,255,255,.05);backdrop-filter:blur(10px);border:1px solid rgba(255,255,255,.08);border-radius:20px;overflow:hidden;text-decoration:none;transition:all .3s;display:block" onmouseover="this.style.transform='translateY(-8px)';this.style.borderColor='rgba(105,108,255,.5)'" onmouseout="this.style.transform='';this.style.borderColor='rgba(255,255,255,.08)'">
        ...
        <div style="padding:18px">
          ...
          <div style="color:rgba(255,255,255,.4);font-size:12px;margin-bottom:12px">Sedan · 2024 · Manual · Petrol</div>
      ...
      <a href="{{ route('login') }}" style="background:rgba(255,255,255,.05);backdrop-filter:blur(10px);border:1px solid rgba(255,255,255,.08);border-radius:20px;overflow:hidden;text-decoration:none;transition:all .3s;display:block" onmouseover="this.style.transform='translateY(-8px)';this.style.borderColor='rgba(105,108,255,.5)'" onmouseout="this.style.transform='';this.style.borderColor='rgba(255,255,255,.08)'">
        ...
        <div style="padding:18px">
          ...
          <div style="color:rgba(255,255,255,.4);font-size:12px;margin-bottom:12px">Pickup · 2024 · Manual · Diesel</div>
          <div style="display:flex;justify-content:space-between;align-items:center">
      ...
      <a href="{{ route('login') }}" style="background:rgba(255,255,255,.05);backdrop-filter:blur(10px);border:1px solid rgba(255,255,255,.08);border-radius:20px;overflow:hidden;text-decoration:none;transition:all .3s;display:block" onmouseover="this.style.transform='translateY(-8px)';this.style.borderColor='rgba(105,108,255,.5)'" onmouseout="this.style.transform='';this.style.borderColor='rgba(255,255,255,.08)'">
        ...
        <div style="padding:18px">
          ...
          <div style="color:rgba(255,255,255,.4);font-size:12px;margin-bottom:12px">SUV · 2025 · Automatic · Petrol</div>
          <div style="display:flex;justify-content:space-between;align-items:center">
...
<section class="modules" id="modules">
  <div class="sw" style="text-align:center">
    ...
    <div class="mod-grid">
      <a href="{{ route('login') }}" class="mod-card reveal"><div class="mod-icon"><i class='bx bx-car'></i></div><h5>Vehicles</h5><p>Full inventory management with images, documents & QR codes</p></a>
      <a href="{{ route('login') }}" class="mod-card reveal"><div class="mod-icon"><i class='bx bx-receipt'></i></div><h5>Sales</h5><p>Record and track every sale with customer details</p></a>
      <a href="{{ route('login') }}" class="mod-card reveal"><div class="mod-icon"><i class='bx bx-user'></i></div><h5>Customers</h5><p>Complete CRM with CNIC and purchase history</p></a>
      <a href="{{ route('login') }}" class="mod-card reveal"><div class="mod-icon"><i class='bx bx-money'></i></div><h5>Payments</h5><p>Cash, cheque and bank transfer records</p></a>
      <a href="{{ route('login') }}" class="mod-card reveal"><div class="mod-icon"><i class='bx bx-file'></i></div><h5>Invoices</h5><p>Professional invoices with email & WhatsApp sharing</p></a>
      <a href="{{ route('login') }}" class="mod-card reveal"><div class="mod-icon"><i class='bx bx-purchase-tag-alt'></i></div><h5>Purchases</h5><p>Track supplier purchases and costs</p></a>
      <a href="{{ route('login') }}" class="mod-card reveal"><div class="mod-icon"><i class='bx bx-transfer'></i></div><h5>Branch transfers</h5><p>Approve/reject vehicle movement between branches</p></a>
      <a href="{{ route('login') }}" class="mod-card reveal"><div class="mod-icon"><i class='bx bx-line-chart'></i></div><h5>Analytics</h5><p>Charts, revenue by branch and sales trends</p></a>
      <a href="{{ route('login') }}" class="mod-card reveal"><div class="mod-icon"><i class='bx bx-buildings'></i></div><h5>Branches</h5><p>Multi-city branch management and settings</p></a>
      <a href="{{ route('login') }}" class="mod-card reveal"><div class="mod-icon"><i class='bx bx-group'></i></div><h5>Users</h5><p>Manage staff, roles and access per branch</p></a>
      <a href="{{ route('login') }}" class="mod-card reveal"><div class="mod-icon"><i class='bx bx-list-check'></i></div><h5>Audit logs</h5><p>Full activity trail — who did what and when</p></a>
      <a href="{{ route('login') }}" class="mod-card reveal"><div class="mod-icon"><i class='bx bx-cog'></i></div><h5>Settings</h5><p>System configuration and preferences</p></a>
    </div>
  </div>
</section>
...
<section class="roles-s" id="roles">
  <div class="sw">
    ...
    <div class="roles-g">
      <div class="rc reveal" onclick="window.location.href='{{ route('login') }}'"><div class="ri r1"><i class='bx bx-crown'></i></div><h5>Super Admin</h5><p>Full system access across all branches and modules</p></div>
      <div class="rc reveal" onclick="window.location.href='{{ route('login') }}'"><div class="ri r2"><i class='bx bx-building'></i></div><h5>HO Admin</h5><p>Head office management, reporting and oversight</p></div>
      <div class="rc reveal" onclick="window.location.href='{{ route('login') }}'"><div class="ri r3"><i class='bx bx-user-check'></i></div><h5>Branch Manager</h5><p>Manage vehicles, staff and operations at branch</p></div>
      <div class="rc reveal" onclick="window.location.href='{{ route('login') }}'"><div class="ri r4"><i class='bx bx-store'></i></div><h5>Sales Staff</h5><p>Process sales and manage customer relationships</p></div>
      <div class="rc reveal" onclick="window.location.href='{{ route('login') }}'"><div class="ri r5"><i class='bx bx-calculator'></i></div><h5>Accountant</h5><p>Payments, invoices and all financial records</p></div>
    </div>
  </div>
</section>
  ...
  <div class="sw">
    <div class="pwa-inner">
      <div>
        ...
        <p style="color:#7a7a9a;font-size:15px;line-height:1.8;" class="reveal">Velora VMS is a Progressive Web App — branch staff can keep working even when the internet goes down. Data saves locally and syncs automatically when reconnected.</p>
...
{{-- VEHICLES SHOWCASE (light section) --}}
<section style="padding:100px 0;background:#07070f" id="vehicles-light">
  <div class="sw">
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:24px;margin-top:48px" class="reveal">
      <a href="{{ route('login') }}" style="background:#121220;border-radius:16px;overflow:hidden;border:1px solid rgba(105,108,255,.15);transition:all .3s;text-decoration:none;display:block" onmouseover="this.style.transform='translateY(-6px)';this.style.boxShadow='0 12px 40px rgba(105,108,255,.15)';this.style.borderColor='rgba(105,108,255,.35)'" onmouseout="this.style.transform='';this.style.boxShadow='';this.style.borderColor='rgba(105,108,255,.15)'">
        ...
        <div style="padding:20px">
          <h4 style="color:#f0f0ff;font-size:16px;font-weight:700;margin-bottom:4px">Toyota Yaris GLi</h4>
          <p style="color:#7a7a9a;font-size:13px;margin-bottom:12px">Sedan · 2024 · Manual · Petrol</p>
          <div style="display:flex;justify-content:space-between;align-items:center">
      ...
      <a href="{{ route('login') }}" style="background:#121220;border-radius:16px;overflow:hidden;border:1px solid rgba(105,108,255,.15);transition:all .3s;text-decoration:none;display:block" onmouseover="this.style.transform='translateY(-6px)';this.style.boxShadow='0 12px 40px rgba(105,108,255,.15)';this.style.borderColor='rgba(105,108,255,.35)'" onmouseout="this.style.transform='';this.style.boxShadow='';this.style.borderColor='rgba(105,108,255,.15)'">
        <div style="background:linear-gradient(135deg,#1a1a2e,#2b2c40);height:180px;display:flex;align-items:center;justify-content:center;position:relative;overflow:hidden">
          ...
          <span style="position:absolute;top:12px;right:12px;background:#ffab00;color:#fff;padding:4px 12px;border-radius:20px;font-size:12px;font-weight:600">Reserved</span>
          <span style="position:absolute;bottom:12px;left:12px;background:rgba(113,221,55,.15);color:#71dd37;padding:4px 12px;border-radius:20px;font-size:11px">Karachi Branch</span>
        </div>
        <div style="padding:20px">
          <h4 style="color:#f0f0ff;font-size:16px;font-weight:700;margin-bottom:4px">Toyota Hilux XLi</h4>
          <p style="color:#7a7a9a;font-size:13px;margin-bottom:12px">Pickup · 2024 · Manual · Diesel</p>
          <div style="display:flex;justify-content:space-between;align-items:center">
      ...
      <a href="{{ route('login') }}" style="background:#121220;border-radius:16px;overflow:hidden;border:1px solid rgba(105,108,255,.15);transition:all .3s;text-decoration:none;display:block" onmouseover="this.style.transform='translateY(-6px)';this.style.boxShadow='0 12px 40px rgba(105,108,255,.15)';this.style.borderColor='rgba(105,108,255,.35)'" onmouseout="this.style.transform='';this.style.boxShadow='';this.style.borderColor='rgba(105,108,255,.15)'">
        <div style="background:linear-gradient(135deg,#0f3460,#16213e);height:180px;display:flex;align-items:center;justify-content:center;position:relative;overflow:hidden">
          ...
          <span style="position:absolute;top:12px;right:12px;background:#696cff;color:#fff;padding:4px 12px;border-radius:20px;font-size:12px;font-weight:600">Available</span>
          <span style="position:absolute;bottom:12px;left:12px;background:rgba(3,195,236,.15);color:#03c3ec;padding:4px 12px;border-radius:20px;font-size:11px">Islamabad Branch</span>
        </div>
        <div style="padding:20px">
          <h4 style="color:#f0f0ff;font-size:16px;font-weight:700;margin-bottom:4px">Land Cruiser GR</h4>
          <p style="color:#7a7a9a;font-size:13px;margin-bottom:12px">SUV · 2025 · Automatic · Petrol</p>
          <div style="display:flex;justify-content:space-between;align-items:center">
...
<section class="cta-s">
  <div class="cta-inner">
    <span class="chip reveal" style="background:rgba(105,108,255,.15);color:#a8aaff">Get started</span>
